...
public class MainFrame extends JFrame{
	...
	public MainFrame(String title, int dco, ArrayList<Task> cachedItems) {
		...
		JLabel todoLabel = new JLabel("Tareas por realizar:"),
				didLabel = new JLabel("Tareas realizadas:");
	...
	private class Command implements ActionListener {
		...
		public static final String DID = "marcar";
		public static final String DID_ALL = "marcar-todas";
		public static final String DEL = "borrar";
		public static final String DEL_ALL = "borrar-todas";
		public static final String SAVE = "guardar";
		public static final String RESTORE = "deshacer";
		...
		public void actionPerformed(ActionEvent e) {
			...
			switch(command[0].trim()) {
				...
				case RESTORE:
					try {
						tasks = FileHelper.readFrom(FileHelper.BACKUP_FILENAME);
